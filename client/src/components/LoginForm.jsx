...
const LoginForm = () => {
    ...
    return (
        ...
        <form className="flex flex-col justify-center gap-[5%] items-center w-[90%] h-[25%] bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 " onSubmit={login}>
            ...
            <button type="submit" className="bg-blue-600 w-[30%] hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition duration-300">Login</button>
        </form>
    )
}
